    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pb1).setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent playMusic= new Intent(MusicActivity.this,PlayActivity.class);
        ...
        findViewById(R.id.pb17).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Intent playMusic= new Intent(MusicActivity.this,PlayActivity.class);
        ...
        findViewById(R.id.pb19).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Intent playMusic= new Intent(MusicActivity.this,PlayActivity.class);
        ...
        findViewById(R.id.pb21).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Intent playMusic= new Intent(MusicActivity.this,PlayActivity.class);
        ...
        findViewById(R.id.pb18).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Toast.makeText(getApplicationContext(),"Details",Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.pb20).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Toast.makeText(getApplicationContext(),"Details",Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.pb22).setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Inform the user the button has been clicked
                Toast.makeText(getApplicationContext(),"Details",Toast.LENGTH_SHORT).show();
